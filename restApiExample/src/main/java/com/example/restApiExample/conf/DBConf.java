...
public class DBConf {
    ...
    public DataSource dataSourceFotaLocal() {
        ...
        dataSource.setUrl("jdbc:log4jdbc:mariadb://118.220.16.112:44444/fota?autoReconnect=true&useUnicode=true&characterEncoding=utf8");
//        dataSource.setUrl("jdbc:log4jdbc:mariadb://118.220.16.112:44444/test01?autoReconnect=true&useUnicode=true&characterEncoding=utf8");
        dataSource.setUsername("quantum");
        dataSource.setPassword("Vd!D7o@o0bfmgSekb2");
